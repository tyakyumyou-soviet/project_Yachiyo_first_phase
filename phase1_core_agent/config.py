...
OLLAMA_FIRST_TOKEN_TIMEOUT_SECONDS = float(os.getenv("OLLAMA_FIRST_TOKEN_TIMEOUT_SECONDS", "8"))
TURN_STREAM_TIMEOUT_SECONDS = float(os.getenv("TURN_STREAM_TIMEOUT_SECONDS", "18"))
